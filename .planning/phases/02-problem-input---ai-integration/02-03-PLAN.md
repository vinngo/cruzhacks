...
must_haves:
  ...
  key_links:
    ...
    - from: "components/workspace/CanvasPanel.tsx"
      ...
      via: "callback or context to trigger AI analysis"
      pattern: "onCanvasChange|triggerAnalysis"
...
- Pass onCanvasCapture callback from workspace page → CanvasPanel
- ChatPanel exposes triggerAnalysis(canvasImage) method via ref or context
- CanvasPanel calls callback which triggers ChatPanel analysis
